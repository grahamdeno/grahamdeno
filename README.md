...
| **Trust**             | [`ai-adoption-gate`](https://github.com/grahamdeno/ai-adoption-gate)                                     | Trustworthy AI is a product decision, not a model decision. Decision gates for adopting AI features: classify what a feature actually does, match it to the oversight it requires, and put trust decisions on record before the build starts |
